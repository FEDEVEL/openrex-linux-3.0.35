...
#define SABRESD_USR_DEF_RED_LED	IMX_GPIO_NR(1, 19)
#define SABRESD_VOLUME_UP	IMX_GPIO_NR(6, 9)
#define SABRESD_VOLUME_DN	IMX_GPIO_NR(6, 8)
...
#define SABRESD_ECSPI1_CS0  	IMX_GPIO_NR(2, 30)
...
static void __init mx6_sabresd_board_init(void)
{
	...
	*/
	...
	//!MM imx6q_add_sdhci_usdhc_imx(2, &mx6q_sabresd_sd3_data);
